...
function AddService() {
  ...
  const handleSubmit = async(e)=>{
    ...
    const {data} = await axios.post("http://localhost:5000/add-services", initial);
  ...
  return (
    <div className="min-h-screen max-w-2xl shadow-xl p-20 mx-auto">
      <h1 className="font-montserrat text-2xl text-center text-blue-500">
        Add Your Service
      </h1>
      <p className="text-center font-poppins text-gray-700 my-3 bg-base-200 p-4 font-semibold">Add your service now to showcase your expertise, gather reviews, and connect with a wider audience. </p>
        ...
        <div className="flex items-center gap-10">
          ...
          <div>
           ...
           <FormControl fullWidth >
             ...
             >
             <MenuItem key=""><em>None</em></MenuItem>
               {names.map((name) => (
                       <MenuItem
                         key={name}
                         value={name}
